...
ok ($res->name.": ".$res->centroid->lat."/".$res->centroid->long eq 'Potsdamer Platz: 52.50939/13.37642');

my ($reverse)  = $geo->find_closest('address', [52.4870,13.4248]);
ok (join (' ', $reverse->properties('addr:housenumber', 'addr:street', 'addr:postcode', 'addr:city')) eq '10 Hasenheide 10967 Berlin');
